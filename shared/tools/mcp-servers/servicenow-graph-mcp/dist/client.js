...
export class ServiceNowClient {
    ...
    buildHttp(sessionCookie, userToken) {
        return axios.create({
    ...
    async reauthenticate() {
        ...
        this.reauthInProgress = (async () => {
            process.stderr.write("[servicenow-mcp] Session expired. Opening browser for re-authentication...\n");
            try {
     ...
     */
    async getJournalEntries(sysId, element = "all", limit = 50) {
