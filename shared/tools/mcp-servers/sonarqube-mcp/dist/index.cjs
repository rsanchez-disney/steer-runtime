...
var require_client = __commonJS({
  "build/client.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.SonarQubeClient = void 0;
    var SonarQubeClient = class {
      config;
      timeout;
      constructor(config) {
        this.config = {
    ...
    exports2.SonarQubeClient = SonarQubeClient;
  }
});

// build/tools.js
var require_tools = __commonJS({
  "build/tools.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.tools = void 0;
    exports2.handleToolCall = handleToolCall;
    exports2.tools = [
      {
    ...
    async function handleToolCall(client2, name, args) {
      try {
        let result;
        switch (name) {
          case "sq_validate_connection":
            result = await client2.validate();
            if (result.ok) {
          ...
          case "sq_list_projects":
            result = await client2.listProjects({
              query: args.query,
              pageSize: args.page_size
            });
            break;
          case "sq_get_issues":
            result = await client2.getIssues({
          ...
          case "sq_get_measures":
            result = await client2.getMeasures({
          ...
          case "sq_get_hotspots":
            result = await client2.getHotspots({
              projectKey: args.project_key,
              status: args.status,
              pageSize: args.page_size
            });
          ...
          case "sq_get_quality_gate":
            result = await client2.getQualityGate({
              projectKey: args.project_key
            });
            break;
          case "sq_get_source":
            result = await client2.getSource({
              key: args.key,
              from: args.from,
              to: args.to
            });
...
var index_js_1 = (init_server(), __toCommonJS(server_exports));
var stdio_js_1 = (init_stdio2(), __toCommonJS(stdio_exports));
var types_js_1 = (init_types2(), __toCommonJS(types_exports));
var client_js_1 = require_client();
var tools_js_1 = require_tools();
var server = new index_js_1.Server({ name: "sonarqube-mcp", version: "0.1.0" }, { capabilities: { tools: {} } });
var client = new client_js_1.SonarQubeClient({
  url: process.env.SONARQUBE_URL || "https://sonar.cicd.wdprapps.disney.com",
  token: process.env.SONARQUBE_TOKEN || "",
  organization: process.env.SONARQUBE_ORG || void 0
});
