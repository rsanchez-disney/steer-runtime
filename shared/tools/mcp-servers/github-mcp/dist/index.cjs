...
var Protocol = class {
  ...
  _onnotification(notification) {
    var _a;
    const handler2 = (_a = this._notificationHandlers.get(notification.method)) !== null && _a !== void 0 ? _a : this.fallbackNotificationHandler;
    if (handler2 === void 0) {
      return;
    }
  ...
  _onrequest(request2, extra) {
    var _a, _b;
    const handler2 = (_a = this._requestHandlers.get(request2.method)) !== null && _a !== void 0 ? _a : this.fallbackRequestHandler;
  ...
  setRequestHandler(requestSchema, handler2) {
    ...
    this._requestHandlers.set(method, (request2, extra) => {
      return Promise.resolve(handler2(requestSchema.parse(request2), extra));
    });
  }
  /**
  ...
  setNotificationHandler(notificationSchema, handler2) {
    this._notificationHandlers.set(notificationSchema.shape.method.value, (notification) => Promise.resolve(handler2(notificationSchema.parse(notification))));
  }
  /**
...
async function handleGithubUpdatePr(args) {
  ...
  if (reviewers) {
    await octokit2.pulls.requestReviewers({
      owner,
      repo: repoName,
      pull_number: prNum,
      reviewers
