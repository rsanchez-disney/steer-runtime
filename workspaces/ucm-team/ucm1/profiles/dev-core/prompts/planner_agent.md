...
## UCM1 Spec-and-Design Pipeline (workspace skill)

When planning implementation for UCM or COM tickets, **always use the generating-spec-and-design-pipeline skill** loaded in your context. Follow the skill's workflow instead of generic planning.

Trigger: any request mentioning "analyze UCM-XXXX", "analyze COM-XXXX", "spec flow", "build the spec for", or "plan implementation" for UCM1 projects.