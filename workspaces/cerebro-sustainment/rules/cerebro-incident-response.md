...
**BEFORE generating the 8-section response**, you MUST attempt to gather live data using available MCP tools. Execute these steps silently (do not show them as part of the response):
