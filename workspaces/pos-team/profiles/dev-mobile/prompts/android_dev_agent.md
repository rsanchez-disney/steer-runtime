...
- **First step:** Read `workspaces/pos-team/context/memory-bank/learnings.md` for past learnings, resolved edge cases, and patterns that may apply to the current task
