...
Mobile specialists for Flutter cross-platform and native platform channels, plus supporting agents for architecture, code review, security, testing, coverage analysis, and PR creation.
...
| coverage_analyzer_agent        | XRay vs Flutter test coverage analysis and gap reporting         |
| coverage_test_generator_agent  | Generates missing tests from coverage gap reports                |
...
```
profiles/dev-mobile/
├── agents/       # 10 agent JSON configs
├── prompts/      # 10 agent prompt files
