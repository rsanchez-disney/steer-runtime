...
**Path resolution:** Use the absolute path `~/.kiro/.specs/` (e.g., `/home/username/.kiro/.specs/` on Linux, `/Users/username/.kiro/.specs/` on macOS). Do NOT create a `.kiro/` folder inside the current project directory.
...
2. Map affected architectural layers (routes, controllers, services, transformers, processors, models, etc.)
...
<!-- Performance, security, accessibility, backward compatibility -->

- [ ] NFR-1: ...

## Acceptance Criteria

<!-- From the Jira ticket + any discovered during analysis -->
...
<!-- External services, other tickets, or teams that must be coordinated -->
...
<!-- Current state, constraints, and relevant background -->
...
<!-- New or modified interfaces, API contracts, request/response shapes -->

## Service Dependencies

<!-- External services called, URLs, methods, headers -->
...
<!-- Key scenarios the implementation must cover -->

| Scenario                     | Type   | Expected Outcome              |
|------------------------------|--------|-------------------------------|
| Happy path                   | Unit   | ...                           |
| Service failure              | Unit   | ...                           |
| Unauthorized access          | Unit   | ...                           |
...
<!-- Decisions still pending — resolve before implementation -->
