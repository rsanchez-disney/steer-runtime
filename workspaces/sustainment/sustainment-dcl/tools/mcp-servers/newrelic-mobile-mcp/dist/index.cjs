  ...
  async loadConfig() {
    ...
    if (!this.apiKey || !this.accountId) {
      try {
        ...
        console.error(`Failed to load .env: ${e2.message}`);
      }
    }
    if (!this.apiKey || !this.accountId) {
  ...
  async graphql(query) {
    ...
    try {
      ...
      if (data.errors?.length) {
        throw new Error(`NerdGraph: ${data.errors.map((e2) => e2.message).join("; ")}`);
      }
      return data;
    } finally {
...
var apiClient = new NewRelicApiClient();

// src/tools/nrqlQuery.ts
var nrqlQuerySchema = {
  name: "nrql_query",
...
async function handleNrqlQuery(args) {
  const { query } = args;
...
// src/tools/getCrashRate.ts
var getCrashRateSchema = {
  name: "get_crash_rate",
...
// src/tools/getTopCrashes.ts
var getTopCrashesSchema = {
...
async function handleGetTopCrashes(args) {
...
// src/tools/getAdoptionRate.ts
var getAdoptionRateSchema = {
...
async function handleGetAdoptionRate(args) {
