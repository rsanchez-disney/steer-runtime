# Development workspace for the steer ecosystem — runtime, Koda, Kite, Mouseketool, plugins, scoring — Team Context
...
- **steer-runtime** (SANCR225/steer-runtime) — agent configs, prompts, context, hooks, MCP servers, workspaces
