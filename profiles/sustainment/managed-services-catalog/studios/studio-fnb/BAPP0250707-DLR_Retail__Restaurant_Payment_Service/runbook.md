# Runbook — DLR Retail & Restaurant Payment Service

## Restart Procedures

1. AWS Console → ECS → Cluster: rr-payment-prod (us-west-2)
...
**Validation:**
- Health check: `https://latest.rr-payment.dlr.wdprapps.disney.com/healthcheck`
- Swagger: `https://latest.rr-payment.dlr.wdprapps.disney.com/webjars/swagger-ui/index.html`
- Splunk: index=wdpr-revmgmt service=rr-payment-service aws_region=us-west-2
