# Troubleshooting — WDW Retail Ordering Orchestration
...
**Resolution:**
1. Check health: `https://wdw-roo.wdprapps.disney.com/svc/healthcheck`
2. Splunk: `index=wdw_ro_service level=ERROR`
