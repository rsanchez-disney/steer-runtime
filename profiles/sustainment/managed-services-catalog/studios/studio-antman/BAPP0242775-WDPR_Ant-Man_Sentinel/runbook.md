# Runbook — WDPR Ant-Man Sentinel

## Restart Procedures

1. Identify unhealthy ECS tasks via AWS Console (account: 211570175858, service: d-tour-sentinel-prod-live)
...
**Validation:**
- Health check returns 200: `https://d-tour-sentinel.wdprapps.disney.com/information`
- Splunk error rate returns to baseline: `index="wdpr_d-scribe" source="*sentinel-prod*" level=ERROR earliest=-15m | timechart count`
