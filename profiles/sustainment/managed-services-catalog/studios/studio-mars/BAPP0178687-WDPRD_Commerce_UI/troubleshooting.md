# Troubleshooting — Commerce UI

## Query Templates

### By SWID
```spl
index=wdpr_commerce_ui "{SWID}" earliest=-7d | head 20
```

### Errors
```spl
index=wdpr_commerce_ui "PCI_COMMERCE_UI_ERROR" earliest=-1h | stats count by _time
```
